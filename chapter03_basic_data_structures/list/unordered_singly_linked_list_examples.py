from chapter03_basic_data_structures.list.unordered_singly_linked_list import UnorderedSinglyLinkedList


def main():
    unordered_linked_list = UnorderedSinglyLinkedList()
